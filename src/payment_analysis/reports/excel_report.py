...
class ExcelReportBuilder:
    ...
    def build_supplier_reconciliation(
        ...
        summary_rows = [
            ...
            {"metric_code": "orders_in_salesdrive", "metric_name": "Заказы SalesDrive в сверке", "value": summary.orders_in_salesdrive},
            ...
            {"metric_code": "orders_amount_in_salesdrive", "metric_name": "Сумма заказов SalesDrive в сверке", "value": summary.orders_amount_in_salesdrive},
